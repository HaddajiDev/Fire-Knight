...
public class EnemySpawner : MonoBehaviour
{
    ...
    private void Spawn()
    {
        ...
        {
            Enemy _enemy = Instantiate(Enemeis.GeneralEnemies[Random.Range(0, Enemeis.GeneralEnemies.Length)], spawnPoint.position, Quaternion.identity).GetComponent<Enemy>();
            _enemy.type = GetRandomEnemyType(Enemy.EnemyType.Chase, Enemy.EnemyType.Patrol);
